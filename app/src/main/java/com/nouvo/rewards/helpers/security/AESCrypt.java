...
final class AESCrypt {
     ...
     */
    private static byte[] encrypt(final SecretKeySpec key, final byte[] iv, final byte[] message) throws GeneralSecurityException {
...
//    public static String decryptJS2(String cipherText, String secret) {
//        try {
//            byte[] cipherData = Base64.encode(cipherText.trim().getBytes(), Base64.NO_WRAP);
//            byte[] saltData = Arrays.copyOfRange(cipherData, 8, 16);
//            MessageDigest md5 = MessageDigest.getInstance("MD5");
//
//
